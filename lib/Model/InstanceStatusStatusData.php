...
class InstanceStatusStatusData implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'msg' => 'string',
        'submsg' => 'string',
        'actions' => '\ChatApiWhatsApp\Model\InstanceStatusStatusDataActions',
        'reason' => 'string'
    ];
     ...
     * Gets actions
     *
     * @return \ChatApiWhatsApp\Model\InstanceStatusStatusDataActions|null
     */
     ...
     * Sets actions
     *
     * @param \ChatApiWhatsApp\Model\InstanceStatusStatusDataActions|null $actions actions
     *
     * @return $this
     */
